...
internal static partial class AngularSpeed
{
    ...
    private static double GetMultiplier(AngularSpeedUnit unit)
    {
        return unit switch
        {
            ...
            AngularSpeedUnit.DegreePerSecond => 1 / 180 * Constants.PI,
            AngularSpeedUnit.DegreePerMinute => 1 / 180 * Constants.PI / 60,
            AngularSpeedUnit.DegreePerHour => 1 / 180 * Constants.PI / 3600,
            AngularSpeedUnit.DegreePerDay => 1 / 180 * Constants.PI / 86400,
