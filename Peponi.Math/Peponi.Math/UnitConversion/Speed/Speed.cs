...
internal static partial class Speed
{
    ...
    private static double GetMultiplier(SpeedUnit unit)
    {
        return unit switch
        {
            ...
            SpeedUnit.KnotUK => 0.5147733333,
            SpeedUnit.MachATM20C => 343.6,
            SpeedUnit.MachSI => 295.0464000003,
            SpeedUnit.VelocityOfSoundInPureWater => 1482.6999999998,
            SpeedUnit.VelocityOfSoundInSeaWater10Meter20C => 1521.6,
            SpeedUnit.VelocityOfLightInVacuum => 299792458,
            SpeedUnit.CosmicVelocity1st => 7899.9999999999,
            SpeedUnit.CosmicVelocity2nd => 11200,
            SpeedUnit.CosmicVelocity3nd => 16670,
