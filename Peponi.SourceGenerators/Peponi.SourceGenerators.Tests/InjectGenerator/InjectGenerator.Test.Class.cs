...
{
    [TestMethod]
    public void ClassWithDependency()
    {
...
namespace GeneratorTest
{
    ...
    [TestMethod]
    public void ClassWithDependencyAndModel()
    {
        Assert.IsTrue(InjectCompare.CompareCode(
@"using Peponi.SourceGenerators;
...
namespace GeneratorTest
{
    ...
    [TestMethod]
    public void ClassWithTypeModifier()
    {
        Assert.IsTrue(InjectCompare.CompareCode(
@"using Peponi.SourceGenerators;
...
namespace GeneratorTest
{
    ...
    [TestMethod]
    public void ClassWithModelWithNotifyNone()
    {
        Assert.IsTrue(InjectCompare.CompareCode(
@"using Peponi.SourceGenerators;
...
namespace GeneratorTest
{
    ...
    [TestMethod]
    public void ClassWithMultiDependency()
    {
        Assert.IsTrue(InjectCompare.CompareCode(
@"using Peponi.SourceGenerators;
...
namespace GeneratorTest
{
    ...
    [TestMethod]
    public void ClassWithMultiModel()
    {
        Assert.IsTrue(InjectCompare.CompareCode(
@"using Peponi.SourceGenerators;
