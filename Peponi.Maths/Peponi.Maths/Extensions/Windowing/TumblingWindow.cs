...
public static class TumblingWindowsExtensions
{
    ...
    /// <inheritdoc cref="TumblingWindows.ToTumblingWindowsCore{T}(IEnumerable{T}, uint, uint, uint)"/>
    ...
    /// <inheritdoc cref="TumblingWindows.ToTumblingWindowsCore{T, V}(IEnumerable{T}, uint, uint, uint, Func{T, V}?)"/>
    ...
    /// <inheritdoc cref="TumblingWindows.ToTumblingWindowsCore(IEnumerable{DateTime}, DateTime, DateTime, TimeSpan)"/>
    ...
    /// <inheritdoc cref="TumblingWindows.ToTumblingWindowsCore{T, V}(IEnumerable{T}, DateTime, DateTime, TimeSpan, Func{T, DateTime}, Func{T, V})"/>
