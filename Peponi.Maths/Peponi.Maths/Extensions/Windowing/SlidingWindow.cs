...
public static class SlidingWindowsExtensions
{
    ...
    /// <inheritdoc cref="SlidingWindows.ToSlidingWindows{T}(IEnumerable{T}, uint, uint, uint)"/>
    ...
    /// <inheritdoc cref="SlidingWindows.ToSlidingWindows{T, V}(IEnumerable{T}, uint, uint, uint, Func{T, V}?)"/>
    ...
    /// <inheritdoc cref="SlidingWindows.ToSlidingWindows(IEnumerable{DateTime}, DateTime, DateTime, TimeSpan)"/>
    ...
    /// <inheritdoc cref="SlidingWindows.ToSlidingWindows{T, V}(IEnumerable{T}, DateTime, DateTime, TimeSpan, Func{T, DateTime}, Func{T, V})"/>
