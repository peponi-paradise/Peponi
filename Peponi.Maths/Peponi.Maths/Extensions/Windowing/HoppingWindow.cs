...
public static class HoppingWindowsExtensions
{
    ...
    /// <inheritdoc cref="HoppingWindows.ToHoppingWindowsCore{T}(IEnumerable{T}, uint, uint, uint, uint)"/>
    ...
    /// <inheritdoc cref="HoppingWindows.ToHoppingWindowsCore{T, V}(IEnumerable{T}, uint, uint, uint, uint, Func{T, V}?)"/>
    ...
    /// <inheritdoc cref="HoppingWindows.ToHoppingWindowsCore(IEnumerable{DateTime}, DateTime, DateTime, TimeSpan, TimeSpan)"/>
    ...
    /// <inheritdoc cref="HoppingWindows.ToHoppingWindowsCore{T, V}(IEnumerable{T}, DateTime, DateTime, TimeSpan, TimeSpan, Func{T, DateTime}, Func{T, V})"/>
