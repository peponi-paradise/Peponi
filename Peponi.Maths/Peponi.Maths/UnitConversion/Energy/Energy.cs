...
{
    private static Dictionary<EnergyUnit, double> _multipliers;
    ...
    static Energy()
    {
        _multipliers = new()
        {
            ...
            { EnergyUnit.GramForceCentiMeter, 9.80665E-05 },
            { EnergyUnit.GramForceMeter, 9.80665E-03 },
            { EnergyUnit.KiloGramForceCentiMeter, 9.80665E-02 },
            { EnergyUnit.KiloGramForceMeter, 9.80665 },
            { EnergyUnit.KiloPondMeter, 9.80665 },
